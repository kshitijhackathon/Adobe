...
export const SimpleUpload: React.FC<SimpleUploadProps> = ({ onFileSelect }) => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white/5 backdrop-blur-sm border-2 border-dashed border-gray-600 hover:border-[#ca6a34]/70 rounded-lg p-16 text-center transition-all duration-200">
          <Upload size={64} className="text-gray-400 mx-auto mb-6" />
