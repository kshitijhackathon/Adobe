            ...
            <div className="mt-16 animate-slide-in-up" style={{ animationDelay: '0.8s' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {insightCards.map((card, index) => (
                  <Card
                    key={index}
                    className="rounded-2xl overflow-hidden [background:radial-gradient(50%_50%_at_50%_8%,rgba(59,21,18,1)_0%,rgba(0,0,0,1)_100%)] border-0 relative animate-fade-in-scale animate-card-glow animate-border-flow animate-hover-gradient transition-all duration-500 hover:scale-105 cursor-pointer"
